      ...
      <body className={inter.className}>
        ...
        <div className="contact-actions-container">
          <a href="tel:1300367909" className="contact-btn contact-btn--call" aria-label="Call Solar Spectrum">
            <span className="contact-btn__icon-badge" aria-hidden="true">
              <svg className="contact-btn__icon-svg" viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a href="https://wa.me/61401535001" className="contact-btn contact-btn--chat" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp">
            <span className="contact-btn__icon-badge" aria-hidden="true">
              <svg className="contact-btn__icon-svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
