                    ...
                    <div className={styles.content}>
                        <div className={styles.textGroup}>
                            <h2 className={styles.title}>
                                The Solar Spectrum – A Path to a Sustainable Future
                            </h2>
                            <p className={styles.description}>
                                We are more than a solar company. We are a partner in building a sustainable energy future. We’re empowering Australians to create a smarter, cleaner and more affordable way to power their lives with world leading solar panels, battery storage systems and smart energy technologies. Together, we are moving toward a future of smarter, simpler, clean energy for all.
                            </p>
                        </div>
